...
namespace Sonar {
  ...
  void PauseState::Init() {
    ...
    this->_homeButton.setPosition((this->_data->window.getSize().x / 2) - (this->_homeButton.getLocalBounds().width / 2), (this->_data->window.getSize().y / 3 * 2) - (this->_resumeButton.getLocalBounds().height / 2));
  }
